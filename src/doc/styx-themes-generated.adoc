...
Type: `String`.  +
Optional, defaults to `null`.
`path`::: Path of the link to generate. +
Type: `String`.  +
Optional, defaults to `null`.
...
.Code
----
templates.tag.ilink { page = { path = "/about.html"; }; content = "about"; }
----
...
.Code
----
templates.tag.ilink { path = "/files/manual.pdf"; content = "Download manual"; class = "download"; }
----
...
<h1>tags</h1>
<ul>
<li><a href="http://domain.org/tags/foo/">foo</a> (2)</li>
<li><a href="http://domain.org/tags/bar/">bar</a> (1)</li>
</ul>
...
[[templates.taxonomy.path]]
==== templates.taxonomy.path

Description:: Template generating the path of a taxonomy page.
...
[[templates.taxonomy.term.path]]
==== templates.taxonomy.term.path

Description:: Template generating the path of a taxonomy term page.
