...
NOTE: The `themes` attribute is used in the init section to load themes configuration, templates and static files. It is possible to not use `themes` and directly set a different list of themes for each function.
