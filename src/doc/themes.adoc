...
NOTE: It is possible to change styx theme file structure expectations by setting custom functions, see <<lib.themes.loadConf>>, <<lib.themes.loadFiles>> and <<lib.themes.loadTemplates>>.
